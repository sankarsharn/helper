  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        ...
        // Delay before redirect to show the success message
        setTimeout(() => {
          router.push("/demo");
        }, 1500);
      } else {
      ...
      >
        ...
        <div className="bg-white/90 backdrop-blur-sm shadow-lg rounded-2xl w-96 p-8 border border-gray-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className={`w-full bg-gray-700 text-white px-4 py-2 rounded-md transition ${
          ...
          <div className="text-center mt-4">
            <button
              ...
              className={`w-full bg-gray-500 text-white px-4 py-2 rounded-md transition ${
                isLoading ? "opacity-70 cursor-not-allowed" : "hover:bg-gray-600"
              }`}
              disabled={isLoading}
            >
              Sign in with Google
